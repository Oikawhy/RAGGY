...
1. **Нет планирования.** Юридический/бухшалтерский вопрос часто требует разложения на подзадачи: юрисдикция, тип документа, период действия нормы, роль клиента, факты кейса, исключения.
...
- **Cost Budget:** ~0.005-0.10$ за запрос. Для простых шагов графа (роутер, планировщик) можно использовать GPT-5.4 mini или Claude Haiku, для генерации и финального reasoning - GPT-5.4 mini или Claude 4.5/6 Sonnet.
